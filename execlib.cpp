...
int HOPS(int SOURCE, int DEST) {
  ...
  switch (topology) {
    ...
    case Symbol::HYPERCUBESY:
      ...
      break;
    case Symbol::LINESY: DIST = abs(SOURCE - DEST); break;
    case Symbol::MESH2SY:
      T1 = TOPDIM;
...
int GRPDELAY(Interpreter *il, int lSOURCE, int DEST, int LEN) {
  ...
  switch (topology) {
    ...
    case Symbol::FULLCONNSY:
    case Symbol::CLUSTERSY:
      AVEFAN = static_cast<int>(round(log(highest_processor + 1) / ln2));
      MAXFAN = AVEFAN;
      break;
    default: break;
  }
...
bool CHKBUF(ExlibLocal *xl, int STRLOC, int ILEN) {
  ...
  if (
    STRLOC <= 0 || ILEN <= 0 || STRLOC + ILEN > STMAX ||
...
void EXECLIB(Interpreter *il, ExLocal *el, PROCPNT CURPR, int lID) {
  ...
  switch (lID) {
    ...
    case 19: // realloc
      ...
      if (
        xl.H1 < 0 || xl.H1 >= STMAX || il->STARTMEM[xl.H1] != xl.H1 ||
    ...
    case 27: // isalnum
      ...
      il->S[CURPR->T] = 0;
      if (
        (xl.H1 > 47 && xl.H1 < 58) || (xl.H1 > 64 && xl.H1 < 91) ||
        (xl.H1 > 96 && xl.H1 < 123))
        il->S[CURPR->T] = 1;
      break;
    case 28: // isalpha
    ...
    case 34: // ispunct
      ...
      il->S[CURPR->T] = 0;
      if (
        (xl.H1 > 33 && xl.H1 < 48) || (xl.H1 > 57 && xl.H1 < 65) ||
    ...
    case 37: // isxdigit
      ...
      il->S[CURPR->T] = 0;
      if (
        (xl.H1 > 47 && xl.H1 < 58) || (xl.H1 > 64 && xl.H1 < 71) ||
        (xl.H1 > 96 && xl.H1 < 103))
        il->S[CURPR->T] = 1;
      break;
    case 38: // tolower
    ...
    case 39:
      ...
      if (xl.H1 > 96 && xl.H1 < 123)
        il->S[CURPR->T] = xl.H1 - 32;
      break;
    case 40: il->PS = PS::USERSTOP; break;
    case 41:
      CURPR->T = CURPR->T - 1;
    ...
    case 54:
      ...
      if (
        CHKCOMM(&xl, il->S[CURPR->T]) || il->S[CURPR->T - 1] < 0 ||
        il->S[CURPR->T - 2] < 0 || il->S[CURPR->T - 2] > highest_processor ||
    ...
    case 55:
      ...
      if (
        il->S[CURPR->T] <= 0 || CHKCOMM(&xl, il->S[CURPR->T - 1]) ||
      ...
      while (xl.B1 && xl.PNT != 0) {
        ...
        if (
          (xl.H2 == MPIANYSOURCE || il->S[xl.H4 + 2] == xl.H2) &&
    ...
    case 56:
      ...
      if (il->NUMTRACE > 0)
        CHKVAR(il, xl.H2);
      if (
        il->S[xl.H1] < 0 || il->S[xl.H1] > highest_processor ||
    ...
    case 58: {
      ...
      if (il->MPICODE == -1) {
        ...
        il->MPICODE != 58 || il->S[CURPR->T - 1] != il->MPIROOT ||
    ...
    case 59: {
      ...
      if (il->MPICODE == -1) {
        ...
        il->MPICODE != 60 || il->S[CURPR->T - 1] != il->MPIROOT ||
      ...
      for (xl.I = 0; xl.I <= il->MPICNT - 1; ++xl.I) {
        if (
          ((il->MPITYPE == MPIINT || il->MPITYPE == MPICHAR) &&
      ...
      if (CURPR->PID != il->MPIROOT) {
        ...
        xl.R1 = CURPR->TIME +
                highest_processor * (MPINODETIME + std::round(il->MPICNT / 3));
      }
      if (il->MPITIME < xl.R1)
        il->MPITIME = xl.R1;
      if (il->MPISEM == 0) {
    ...
    case 61: {
      ...
      if (il->MPICODE == -1) {
        ...
        il->MPICODE != 61 || il->S[CURPR->T - 2] != il->MPIOP ||
        ...
        if (il->MPITYPE == MPIINT) {
          for (xl.J = 0; xl.J < il->MPICNT; xl.J++) {
            if (il->MPIOP == MPIMAX || il->MPIOP == MPIMIN)
              ...
              il->MPIOP == MPISUM || il->MPIOP == MPILOR ||
              il->MPIOP == MPILXOR)
              xl.H2 = 0;
            else
              xl.H2 = 1;
              ...
              switch (il->MPIOP) {
                ...
                case MPIMIN:
                  if (xl.H2 > xl.H3)
                    xl.H2 = xl.H3;
                  break;
                case MPISUM: xl.H2 = xl.H2 + xl.H3; break;
                case MPIPROD: xl.H2 = xl.H2 * xl.H3; break;
                case MPILAND:
                  if (xl.H3 != 0 && xl.H2 == 1)
                    xl.H2 = 1;
                  else
              ...
              switch (il->MPIOP) {
                ...
                case MPIMIN:
                  if (xl.R2 > xl.R3)
                    xl.R2 = xl.R3;
                  break;
                case MPISUM: xl.R2 = xl.R2 + xl.R3; break;
                case MPIPROD: xl.R2 = xl.R2 * xl.R3; break;
              }
            }
    ...
    case 62: {
      ...
      if (il->MPICODE == -1) {
        ...
        il->MPICODE != 62 || il->S[CURPR->T - 1] != il->MPIOP ||
        il->S[CURPR->T - 2] != il->MPITYPE ||
        il->S[CURPR->T - 3] != il->MPICNT) {
        il->PS = PS::MPIGRPCHK;
        break;
      ...
      if (il->MPISEM == 0) {
        ...
        do {
          proc = il->PTEMP->PDES;
          xl.R1 =
            il->MPITIME + GRPDELAY(il, xl.H1, proc->PROCESSOR, il->MPICNT);
          proc->STATE = State::DELAYED;
          if (proc->TIME < xl.R1)
            proc->WAKETIME = xl.R1;
          else
    ...
    case 63: {
      ...
      if (
        il->S[CURPR->T] <= 0 || il->S[CURPR->T] > STMAX ||
    ...
    case 64: {
      ...
      if (
        il->S[CURPR->T - 4] > MAXDIM || il->S[CURPR->T - 4] <= 0 ||
        CHKCOMM(&xl, il->S[CURPR->T - 5])) {
        il->PS = PS::MPIPARCHK;
        break;
      }
      if (
        !CHKBUF(&xl, il->S[CURPR->T - 2], il->S[CURPR->T - 4]) ||
